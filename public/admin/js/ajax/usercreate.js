...
function submitForm(formData) {
    ...
    $('#showandhidebutton').html('Please wait ....').attr('disabled', true);
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            $('#showandhidebutton').html('Submit').attr('disabled', false);
...
function confirmDelete(id, type) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: '/admin/users/delete/' + id, // Update the URL to your delete route
                type: 'POST',
                data: {
