        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">All Managers </h4>
                    <div class="flex-shrink-0">
                        <a href="{{route('manager.create')}}" class="btn btn-dark  btn-sm">Add new Manager </a>
                                    ...
                                    <tr>
                                        ...
                                        <td style="align-items: end; text-align:end;">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="edit">
                                                <a href="{{url('admin/users/manager/edit',$list->id)}}"  class="btn btn-sm btn-success edit-item-btn"> <i class="ti ti-pencil"></i>
                                                    </a>
                                                </div>
