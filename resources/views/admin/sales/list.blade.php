...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="companyadmin" method="POST" action="{{ route('filter.sales') }}">
                    @csrf()
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 ">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label>From</label>
                                        <input type="month" name="from" id="fromDate" value="{{ date('Y-m') }}" class="form-control">
                                    </div>
                                    <div class="col-md-4">
                                        <label>To</label>
                                        <input type="month" name="to" id="toDate" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <a href="{{route('admin.sales')}}" onclick="clearfilter()" style="margin-top:10px;width:100px;" class="btn btn-dark" id="changetext">Clear Filter</a>
            ...
            <div class="card-body">
                <div class="live-preview">
                    <div class="table-responsive">
                        ...
                        <div id="totalcount" class="alert alert-info">TOTAL SALES: ₹ {{$topFiveSalesSum ?? 0}} </div>
                        ...
                        <table class="table table-bordered  mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sort="string">Month <span class="sort-arrow">&uarr;</span></th>
                            ...
                            <tbody id="appendleads">
                                ...
                                <tr>
                                    <th>{{ ($topFiveSales->currentPage() - 1) * $topFiveSales->perPage() + $index + 1 }}</th>
                                    <td><span style="color:blue">{{ $list->user_name ?? '' }}</span></td>
                                    <td>{{ $list->total_payment ?? '' }}</td>
                                    <td>{{ $list->month ?? '' }}</td>
                                    <td><a href="{{ url('admin/sales/' . $list->add_by . '/' . $currentmonth . '/' . $currentYear) }}" class="btn btn-primary btn-sm">View </a></td>
