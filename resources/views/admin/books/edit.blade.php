                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="live-preview">
                            <form action="{{route('books.updatebook')}}" id="companyadmin" method="post">
                                @csrf()
                                <div class="row">
                                    <!--end col-->
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="firstNameinput" class="form-label">
                                              Title  Name</label>
                                            <input type="text" class="form-control" value="{{$book->title ?? ''}}" name="title" placeholder="Enter your Book Title" id="firstNameinput">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <a href="{{url( $book->cover_image)}}" target="__blank">
                                            <img src="{{url( $book->cover_image)}}" style="width: 100px; height:100px">
