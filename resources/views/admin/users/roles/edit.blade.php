                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="live-preview">
                            <form action="{{route('plans.update')}}" id="companyadmin" method="post">
                                @csrf()
                                <div class="row">
                                    <!--end col-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="compnayNameinput" class="form-label">Role Name</label>
                                            <input type="text" class="form-control" value="{{$plantype->name ?? ''}}" name="name" placeholder="Enter Role Name" id="compnayNameinput">
