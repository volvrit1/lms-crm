            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{route('plans.create')}}" class="btn btn-dark  btn-sm">Add new Role  </a>
                                    ...
                                    <tr>
                                        ...
                                        <td style="align-items: end; text-align:end;">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="edit">
                                                    <a href="{{url('admin/roles/edit',$list->id)}}" class="btn btn-sm btn-success edit-item-btn"> <i class="ti ti-pencil"></i>
                                                    </a>
                                                </div>
