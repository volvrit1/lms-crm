...
<div class="row">
    <div class="col-xl-12">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="companyadmin" method="POST" action="{{ route('invoices.filter') }}">
                            @csrf()
                            ...
                            <div class="live-preview">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label>Search By client / Company name </label>
                                        <input type="search" name="search" placeholder="Search By client/ Company name" class="form-control">
                                    ...
                                    <div class="col-md-6 text-center">
                                        ...
                                        <a href="{{route('invoices.all')}}" onclick="clearfilter()" class="btn btn-dark mt-3" id="changetext">Clear Filter</a>
        ...
        <div class="card">
            ...
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">All Invoices</h4>
                <div class="flex-shrink-0">
                    @if(Auth::user()->role =='admin')

                    <a href="{{ route('invoices.create') }}" class="btn btn-dark btn-sm">Add new Invoice</a>
                        ...
                        <table class="table table-bordered  mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sort="string">Invoice Id<span class="sort-arrow">&uarr;</span></th>
                                    <th data-sort="string">Status <span class="sort-arrow">&uarr;</span></th>
                                    <th data-sort="string">Company Name <span class="sort-arrow">&uarr;</span></th>
                                    <th data-sort="string">Invoice Date <span class="sort-arrow">&uarr;</span></th>
                                    <th data-sort="string">Due Date <span class="sort-arrow">&uarr;</span></th>
                            ...
                            <tbody id="appendleads">
                                ...
                                <tr id="lead-row-{{ $list->id }}">
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <button class="btn btn-sm btn-{{$color}}">{{$message}}</button>
