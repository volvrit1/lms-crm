        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">All Coupon</h4>
                    <div class="flex-shrink-0">
                        <a href="{{route('coupen.create')}}" class="btn btn-dark  btn-sm">Add new Coupon </a>
                    ...
                    <div class="live-preview">
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap mb-0">
                                ...
                                @if(!empty($coupen))
                                    @foreach($coupen as $key=>$list)
                                    <tr>
                                        <th>{{++$key}}</th>
                                        <td>{{$list->coupen_code ?? ''}}</td>
                                        ...
                                        <td style="align-items: end; text-align:end;">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="edit">
                                                    <a href="{{url('admin/coupen/edit',$list->id)}}" class="btn btn-sm btn-success edit-item-btn"> <i class="ti ti-pencil"></i>
                                                    </a>
                                                </div>
