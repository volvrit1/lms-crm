        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">All Sources</h4>
                    <div class="flex-shrink-0">
                        <a href="{{route('source.create')}}" class="btn btn-dark  btn-sm">Add new Source  </a>
                                    ...
                                    <tr>
                                        ...
                                        <td style="align-items: end; text-align:end;">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="edit">
                                                    <a href="{{url('admin/source/edit',$list->id)}}" class="btn btn-sm btn-success edit-item-btn"> <i class="ti ti-pencil"></i>
                                                    </a>
                                                </div>
