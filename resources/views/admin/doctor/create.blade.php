                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="live-preview">
                            <form  id="doctor_add" method="post">
                                @csrf()
                                <div class="row">
                                    <!--end col-->
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="doctor_name" placeholder="Enter Doctor Name" id="doctor_name" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="specialty" placeholder="Enter Specialty " id="specialty" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control onlyNumeric" name="contact_number" placeholder="Contact Number" id="contact_number">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" name="anniversary" placeholder="anniversary" id="anniversary">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" class="form-control" name="clinic_1_address_timings" placeholder="Clinic -1 Address-Timings" id="clinic_1_address_timings" rows="4" ></textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" class="form-control" name="clinic_2_address_timings" placeholder="Clinic -2 Address-Timings" rows="4" id="clinic_2_address_timings"></textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" class="form-control" name="clinic_3_address_timings" placeholder="Clinic -3 Address-Timings" rows="4" id="clinic_3_address_timings"></textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" class="form-control" name="clinic_4_address_timings" placeholder="Clinic -4 Address-Timings" rows="4" id="clinic_4_address_timings"></textarea>
