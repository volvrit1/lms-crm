                                                    ...
                                                    <div class="row align-items-center gy-3">
                                                        ...
                                                        <div class="col-sm-auto">
                                                            <div class="text-lg-end">
                                                                ...
                                                                <h5 class="fs-14">₹<span id="ticket_price" class="product-price"> {{$choosedplan->price ?? ''}}</span></h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                        <tbody>
                                            <tr>
                                                <td>Sub Total</td>
                                                <td class="text-end">₹
                                                    <span class="product-line-price" id="totalvalue">{{$choosedplan->price ?? ''}}</span>
                                                    <input type="hidden" name="totalamount"  value="{{$choosedplan->price ?? ''}}" id="totalvaluetobepay">
                                            ...
                                            <tr>
                                                <td> Tax (18%)</td>
                                                <td class="text-end">₹ <span class="product-line-price" id="taxamount"> {{$choosedplan->price *0.18}}</span>

                                                    <input type="hidden" name="taxpaid" id="taxpaid" value="{{$choosedplan->price *0.18}}">
                                            ...
                                            <tr class="border-top border-top-dashed fs-15">
                                                ...
                                                <th class="text-end">₹ <span class="product-line-price" id="totalmoney">{{$choosedplan->price+$choosedplan->price *0.18}}</span>
                                                <input type="hidden" name="totalmoneyform" id="totalmoneyform" value="{{$choosedplan->price+$choosedplan->price *0.18}}">
